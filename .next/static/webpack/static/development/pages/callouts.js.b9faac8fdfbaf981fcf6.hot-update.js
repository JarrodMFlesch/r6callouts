...
})(["font-size:1.6rem;text-transform:uppercase;letter-spacing:1px;.seconds_s{text-transform:lowercase;}.toggle_time{margin-left:4rem;border:none;color:#fff;text-transform:uppercase;font-size:1.6rem;background:#e82e3b;border-radius:4px;padding:3px 15px;}"]);
...
//# sourceMappingURL=callouts.js.b9faac8fdfbaf981fcf6.hot-update.js.map
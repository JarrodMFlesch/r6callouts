...
})(["background:linear-gradient(120deg,#44505f,#19232e);margin-left:400px;color:#fff;padding:30px;display:flex;justify-content:center;align-items:center;height:calc(100vh - 60px);> div{min-width:80%;min-height:80%;display:flex;flex-direction:column;justify-content:space-between;> div:last-child{flex:1;}> div:nth-child(2){flex:5;}}"]);
...
})(["margin-bottom:10px;font-size:2rem;text-transform:uppercase;letter-spacing:1px;> span:last-child{float:right;}"]);
...
//# sourceMappingURL=callouts.js.ee02f86a38f15c813b4f.hot-update.js.map
...
})(["background:linear-gradient(120deg,#44505f,#19232e);margin-left:400px;color:#fff;padding:30px;display:flex;justify-content:center;align-items:center;height:calc(100vh - 60px);overflow:scroll;> div{width:80%;display:flex;flex-direction:column;justify-content:space-between;> div:last-child{flex:1;}> div:nth-child(2){flex:5;}}"]);
  ...
  _createClass(callout_viewer, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(CalloutViewerWrapper, {
        ...
        timerIsPaused: this.props.timer_is_paused,
...
//# sourceMappingURL=callouts.js.df970ae8de331c7d8aae.hot-update.js.map
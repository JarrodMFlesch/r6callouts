...
function (_Component) {
  ...
  function Callouts() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "changeImage", function () {
      ...
      console.log(_this.state.map_images.length);
      console.log(_this.state.map_image_index + 1);

      if (_this.state.map_image_index !== _this.state.map_images.length - 1) {
        _this.setState({
          map_image_index: _this.state.map_image_index++
        });
      } else {
        _this.setState({
          map_image_index: 0
...
//# sourceMappingURL=callouts.js.2b60b8c0f0fe92a8c860.hot-update.js.map
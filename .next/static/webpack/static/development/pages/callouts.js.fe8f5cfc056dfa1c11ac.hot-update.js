...
})(["border-radius:24px;position:relative;overflow:hidden;img{border-radius:inherit;max-width:100%;max-height:100%;margin:10px 0px;}.answer_overlay{transition:300ms ease;position:absolute;width:100%;height:100%;background:radial-gradient(rgba(0,0,0,0.7) 20%,black);border-radius:inherit;left:100%;top:0;.answer{padding:40px;width:calc(100% - 80px);height:calc(100% - 80px);display:flex;justify-content:center;align-items:center;flex-direction:column;span{font-size:40px;text-align:center;text-transform:uppercase;}}&.show{left:0%;}}"]);
  ...
  _createClass(callout_image_box, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ImageWrapper, {
        ...
        className: this.props.timer === 0 ? 'answer_overlay show' : 'answer_overlay',
        __source: {
          fileName: _jsxFileName,
          lineNumber: 53
        },
...
//# sourceMappingURL=callouts.js.fe8f5cfc056dfa1c11ac.hot-update.js.map
...
var CalloutWrapper = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "callout_viewer__CalloutWrapper",
  componentId: "sc-1em0f5b-0"
})(["background:linear-gradient(120deg,#44505f,#19232e);color:#fff;padding:30px;display:flex;justify-content:center;align-items:center;> div{min-width:80%;min-height:80%;}"]);
...
function (_Component) {
  ...
  _createClass(callout_viewer, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(CalloutWrapper, {
        __source: {
...
//# sourceMappingURL=callouts.js.7d5d84df6099aa87a835.hot-update.js.map
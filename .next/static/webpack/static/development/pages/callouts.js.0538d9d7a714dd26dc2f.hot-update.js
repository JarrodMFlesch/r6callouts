...
})(["font-size:1.6rem;text-transform:uppercase;letter-spacing:1px;display:flex;.time{display:inline;margin:0;line-height:2.4rem;}.seconds_s{text-transform:lowercase;}.toggle_time{cursor:pointer;transition:300ms ease;margin-left:4rem;font-size:2.4rem;display:inline-block;&:hover{color:#d02c2c;}}"]);
...
//# sourceMappingURL=callouts.js.0538d9d7a714dd26dc2f.hot-update.js.map
...
})(["border-radius:24px;position:relative;img{border-radius:inherit;max-width:100%;max-height:100%;margin:10px 0px;box-shadow:0px 0px 6px 0px #212121;}.answer_overlay{transition:300ms ease;position:absolute;width:100%;height:calc(100% - 20px);margin-top:10px;background:radial-gradient(rgba(0,0,0,0.7) 20%,black);border-radius:inherit;left:100%;top:0;opacity:0;.answer{padding:40px;width:calc(100% - 80px);height:calc(100% - 80px);display:flex;justify-content:center;align-items:center;flex-direction:column;span{font-size:40px;text-align:center;text-transform:uppercase;}}&.show{left:0%;opacity:1;}}"]);
...
//# sourceMappingURL=callouts.js.5692bb47cf305a5f0969.hot-update.js.map
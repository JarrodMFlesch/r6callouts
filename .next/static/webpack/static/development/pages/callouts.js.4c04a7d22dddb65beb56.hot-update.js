...
})(["font-size:1.6rem;text-transform:uppercase;letter-spacing:1px;.seconds_s{text-transform:lowercase;}.toggle_time{cursor:pointer;margin-left:4rem;border:none;color:#fff;text-transform:uppercase;letter-spacing:1px;font-size:1.6rem;background:#e82e3b;border-radius:4px;padding:3px 15px;font-weight:600;}"]);
  ...
  _createClass(timebar, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(TimebarWrapper, {
        ...
        className: "toggle_time",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 45
        },
        __self: this
      }, this.props.timerIsPaused ? '<FaPlayCircle>' : '<FaPauseCircle>', ' ', "Timer"));
    }
  }]);
...
//# sourceMappingURL=callouts.js.4c04a7d22dddb65beb56.hot-update.js.map
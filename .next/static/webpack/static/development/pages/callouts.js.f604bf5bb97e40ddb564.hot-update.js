...
})(["max-width:400px;background:#0b111a;.maps_header{height:100px;position:relative;display:flex;justify-content:center;align-items:center;&:after{content:'';width:80%;height:2px;background:#fff;position:absolute;bottom:0;margin:auto;}h2{margin:unset;color:#fff;text-transform:uppercase;letter-spacing:2px;font-size:50px;}}.maps{max-height:calc(100vh - 100px);overflow:scroll;width:100%;.map{cursor:pointer;display:block;margin:13.5px auto;border-radius:5px;max-width:275px;box-shadow:0px 3px 8px black;background-image:url(", ");}}"], function (props) {
  return props.bgimg;
});
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Sidebar, {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "map",
          bgimg: "static/images/map_thumbnails/border.jpg",
          __source: {
            fileName: _jsxFileName,
            lineNumber: 56
          },
...
//# sourceMappingURL=callouts.js.f604bf5bb97e40ddb564.hot-update.js.map